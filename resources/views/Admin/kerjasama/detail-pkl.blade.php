                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-4">
                                        ...
                                        <a href="{{ asset('/storage/' .$dokumen->nama_dokumen) }}" class="btn btn-primary d-block w-75 loat-end mx-2 mt-3">download Surat Pengajuan</a><br>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="tambah ml-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nomor_induk[]" value="{{$peserta->nomor_induk}}">
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <div class="form-group">
                                            <label>Nomor Handphone:</label>
                                            <input type="text" class="form-control" name="no_hp[]" value="{{$peserta->no_hp}}">
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="jenis_kelamin[]" value="{{$peserta->jenis_kelamin}}">
                                        </div>
