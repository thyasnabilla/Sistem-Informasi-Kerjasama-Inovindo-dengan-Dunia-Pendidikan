                      ...
                      <div class="card-body">
                        ...
                        @endif
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_pimpinan" value="{{$data->perusahaan->nama_perusahaan}}" readonly>
                            </div>
                          <div class="form-group">
                          ...
                          <div class="col-lg-4">
                                        <div class="form-group">
                                        <a href="{{ asset('/storage/' .$data->dokumen->nama_dokumen) }}" class="btn btn-primary d-block w-100 loat-end mx-2 mt-3">{{ $data->dokumen->keterangan}}</a><br>
