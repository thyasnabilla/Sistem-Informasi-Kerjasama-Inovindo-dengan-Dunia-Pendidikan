...
@section('container')
    <div class="section-header">
        <h1>Detail Pengajuan Kunjungan Siswa ke Inovindo</h1>
    </div>
    <div class="section-body">
        @if($errors->any())
            {!! implode('',$errors->all('<div>:message</div>')) !!}
        @endif
        <form action="/input-kunjin/simpan" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_institusi" value="{{$data->kerjasama->perusahaan->nama_perusahaan}}" readonly>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
