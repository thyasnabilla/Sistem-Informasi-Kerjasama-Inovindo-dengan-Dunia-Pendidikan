...
@section('container')
    <div class="section-header">
        <h1>Detail Pengajuan Pelaksanaan Rekrut Calon Karyawan</h1>
    </div>
    <div class="section-body">
        @if($errors->any())
            {!! implode('',$errors->all('<div>:message</div>')) !!}
        @endif
        <form action="/input-rekrut/simpan" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                            ...
                            <div class="col-lg-4">
                                        <div class="form-group">
                                            @foreach($data->kerjasama->dokumen as $dokumen)
                                                    ...
                                                    <a href="{{ asset('/storage/' .$dokumen->nama_dokumen) }}" class="btn btn-primary d-block w-75 loat-end mx-2 mt-3">{{ $dokumen->keterangan }}</a><br>
