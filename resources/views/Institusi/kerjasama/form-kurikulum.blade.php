...
@section('container')
    <div class="section-header">
        <h1>Formulir Pengajuan Kurikulum</h1>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tanggal_akhir" require>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control-file" id="exampleFormControlFile1"
                                            name="dokumen2" required>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <div class="form-group">
                                        <label for="upload">Upload Randon Acara</label>
                                        <input type="file" class="form-control-file" id="exampleFormControlFile1"
                                            name="dokumen3" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
