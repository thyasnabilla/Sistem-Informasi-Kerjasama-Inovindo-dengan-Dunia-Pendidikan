...
<body>
    ...
    <div class="p2">
        1.<b> {{ $mou->institusi_pimpinan['nama_pimpinan'] }}</b> selaku Kepala <b>{{ $mou->institusi['nama_institusi'] }}</b> , selanjutnya disebut pihak Pertama <br>
    ...
    <div class="p3">
     Pihak Pertama dan Kedua sepakat untuk mengadakan Kerjasama dalam rangka :  
        ...
        <div class="p">
            ...
            {{ $mou->institusi_pimpinan['nama_pimpinan'] }}
        </div>
